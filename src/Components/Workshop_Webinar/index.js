...
const Home = () => {
 let formData = new FormData();
  ...
  const fatchdata = async () => {
    const resp = await axios.get("/workshop");
    console.log(resp);
   setworkshop(resp.data.data);
      ...
      <div className="workshop-main ">
        ...
        >
          ...
          <div className="col-sm-12  col-md-12  col-lg-6">
            <h2>Make Instant Workshop/Webinar</h2>
            <p>Workshop/Webinar should be related to Engineers</p>
          </div>
        </div>
        ...
        >
          <Box sx={style}>
            <textarea
              ...
              type="text"
              placeholder="Write description about Your WorkShop/Webinar"
              style={{
               marginBottom: "2px",
            ...
            <tr>
              <span >Upload image related to workshop</span>{" "}
              <input
                type="file"
                name="file"
                onChange={(e) => {
